...
/* ============================================================
   NAV
   ============================================================ */
function Nav({ onTweaks, tweaksAvail, direction }) {
  ...
  return (
    <section id="film" className="anchor-offset" style={{ paddingTop: 80 }}>
      <div className="wrap">
        ...
        {isMobile ? (
          <div className="mob-swipe mob-swipe-gallery">
            <div className="mob-swipe-video" onClick={() => setOpen(-3)}>
              <video src="img/expect-video.mp4" autoPlay loop muted playsInline />
            </div>
            {GALLERY.map((src, i) =>
              <div key={i} className="mob-swipe-photo"
          ...
          <div className="gallery-wrap">
            <div className="g-video-big" aria-label="Voyage video" onClick={() => setOpen(-3)}>
              <video src="img/expect-video.mp4" autoPlay loop muted playsInline />
            </div>
    ...
    <section className="follow-cta">
      <div className="wrap">
        <div className="follow-cta-inner">
          <h2>Can't wait until <span className="gold">June?</span></h2>
          <p>
...
function App() {
  ...
  return (
    <div>
      <Nav onTweaks={() => setTweaksOpen(true)} tweaksAvail direction={cfg.direction} />
